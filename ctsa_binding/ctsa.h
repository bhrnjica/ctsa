...
//extern "C" CTSABINDINGS_API struct myarima_object;
//extern "C" CTSABINDINGS_API struct sarimax_object;
...
CTSABINDINGS_API struct arima_set{
...
CTSABINDINGS_API struct sarima_set{
	int N;// length of time series
...
CTSABINDINGS_API struct ar_set{
	int N;// length of time series
	int method;
...
CTSABINDINGS_API struct auto_arima_set{
	int N;// length of time series
	int Nused;//length of time series after differencing, Nused = N - d
	int method;
	int optmethod;
...
CTSABINDINGS_API struct sarimax_wrapper_set{
...
namespace ctsaBinding
{
	...
	extern "C" CTSABINDINGS_API int daany_autoarima(int p, int d, int q, double* ts, int tsLength, double* regressors);
	extern "C" CTSABINDINGS_API myarima_object daany_search_arima(double* x, int N, int d, int D, int p_max, int q_max, int P_max, int Q_max, int Order_max, int stationary, int s, const char* ic,
		int approximation, double* xreg, int r, double offset, int allowdrift, int allowmean, int verbose, int method);
